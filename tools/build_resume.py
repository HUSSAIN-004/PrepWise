...
OUT = r"C:\PrepWise-AI\Hussain_M_Kanchwala_Resume_Professional.docx"
...
def add_section_heading(doc, text):
    ...
    run = add_text(p, text.upper(), bold=True, color="1F4D78", size=11)
...
def add_role(doc, title, subtitle, bullets):
    ...
    add_text(p, title, bold=True, size=10.3, color="000000")
...
add_text(
    subtitle,
    "T.E. Artificial Intelligence & Data Science Engineering | Full-Stack Development | Data & Market Research",
    size=9.5,
    color="555555",
)
...
add_text(
    p,
    "AI & Data Science engineering student with hands-on MERN stack experience, strong analytical thinking, and practical exposure to data-driven product development. Experienced in building authenticated dashboards, backend APIs, database-backed workflows, and AI-enabled features. Interested in applying technical, research, and reporting skills to market intelligence, business analysis, and growth-focused internship projects.",
    size=9.6,
)
...
rows = [
    ("Programming & Web", "C++, Java, Python, JavaScript, SQL, Ruby, HTML, CSS, React, Node.js, Express.js, Tailwind CSS"),
    ("Databases & Tools", "MongoDB Atlas, REST APIs, GitHub, VS Code, Postman, Excel, Google Forms, Google Sheets"),
    ("AI/Data & Core CS", "Artificial Intelligence, Pattern Recognition, DBMS, OOPS, Operating Systems, Web Development"),
    ("Market Research", "Secondary research, survey design, data collection, qualitative research, Excel-based analysis, report writing, presentation, business insight generation"),
]
...
add_section_heading(doc, "Market Research Internship Alignment")
add_bullet(doc, "Comfortable collecting structured data through forms, surveys, interviews, and secondary research sources.")
add_bullet(doc, "Able to clean, organize, and interpret data using Excel/Google Sheets and convert findings into concise reports and presentations.")
add_bullet(doc, "Strong fit for research-driven growth work due to a blend of technical execution, analytical thinking, documentation, and business curiosity.")

add_section_heading(doc, "Strengths")
add_bullet(doc, "Analytical problem solver with strong ownership and fast learning ability.")
add_bullet(doc, "Comfortable working across technical development, research, documentation, and presentation tasks.")
add_bullet(doc, "Adaptable team contributor with a practical understanding of full-stack project workflows.")

for section in doc.sections:
    footer = section.footer.paragraphs[0]
    footer.alignment = WD_ALIGN_PARAGRAPH.CENTER
    add_text(footer, "Hussain M. Kanchwala | Resume", size=8, color="777777")
